              ...
              <div class="buttons col-md-2 col-sm-12 col-xs-12">
                ...
                <div class="query col-md-10 col-sm-12 col-xs-12 text-right">
                  <div class="form-group inlineBlock">
                      <label>APP_ID</label>
                      <input id="appInfo.appId" type="text" class="formList" name="appInfo.appId" placeholder="请输入APP_ID" value="${requestScope.appId }"/>
                  </div>
                  <div class="form-group inlineBlock">
                ...
                var dtGridColumns_2_1_2 = [
                  {
                    ...
                    ,{ id: 'appId', title: 'APP_ID', type: 'string', columnClass: 'text-center' }
                    ,{ id: 'appKey', title: 'APP_KEY', type: 'string', columnClass: 'text-center' }
                    ,{ id: 'appName', title: 'APP_NAME', type: 'string', columnClass: 'text-center' }
                    ,{ id: 'createUser', title: 'CREATE_USER', type: 'string', columnClass: 'text-center' }
                    ,{ id: 'createTime', title: 'CREATE_TIME', type: 'date', format:'yyyy-MM-dd hh:mm:ss', otype:'time_stamp_ms', columnClass: 'text-center' }
                    ,{ id: 'status', title: '1有效，0无效', type: 'string', columnClass: 'text-center' }
                ];
